...
import static eva.multiplacer.config.MultiPlacerConfig.*;

public class MultiPlacerConfigScreen implements ModMenuApi {
    public static ConfigBuilder builder() {
        ConfigBuilder builder = ConfigBuilder.create()
                .setTitle(Component.literal("Simply Dual Wielding Config"))
                .setSavingRunnable(JsonConfigHelper::writeToConfig)
                .setEditable(true);
        MultiPlacerConfig INSTANCE = getInstance();
        return builder;
    }
